...
Dabei soll der Code des Katalogeintrags möglichst viel redundante Tipp-Arbeit abnehmen,
...
Um gemeinsam an dem hybriden Konstrukt von \XeLaTeX und Python wurde ein Repository auf der 
...
Was noch fehlt ist die Ausgabe der Seiten, auf denen der Katalogeintrag
 erwähnt wird, wofür der Eintrag \Command{literature} bereit gestellt wird.
