...
\ifdef{\KVmark}{\item[Erwähnung] %\printindex[haus]
}{}
\end{labeling}
\endgroup
}
...
\section{Text}
In meiner Arbeit beschäftige ich mit drei Häusern in Pompeji (\labelcref{haus:M-Fabius-Rufus,haus:Haus-des-Wilden-Ebers,haus:Haus-der-Venus}).
