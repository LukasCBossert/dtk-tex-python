...
Dafür muss der Code des Katalogeintrages \Command{literature}  geändert werden:

\begin{lstlisting}[style=number]
\ifKVmark \item[Erwähnungen] S.~\expandafter\csname\KVlabel-pages\endcsname \fi
  ...
\define@boolkey{catalogue}[KV]{literature}[true]{}
\end{lstlisting}
...
Bei den Katalogeinträgen reicht es, am Ende \Command{literature} einzutragen:
