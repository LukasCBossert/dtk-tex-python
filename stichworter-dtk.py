...
class Stichworter():
    ...
    def regReplace(self, file_path, pattern, subst):
        """ 
        Based on http://stackoverflow.com/questions/39086/search-and-
        replace-a-line-in-a-file-in-python this method uses regular 
        expressions for the matching.
        """
# Create temporary file
    ...
    def process(self, jobname):
        ...
        # create dataframe from the resulting series        
        result = pd.DataFrame(result)
        # Set the index to the Stichwort column, since we are to use this as key
