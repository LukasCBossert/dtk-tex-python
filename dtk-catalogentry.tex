...
Um für ein gegebenes Stichwort bestimmen zu können, auf welchen Seiten es aufgeführt wird, 
muss diese Information schon auf \LaTeX-Ebene weggeschrieben werden.

Dazu bedienen wir uns des \Macro{newwrite} Befehls, der eine neue Ausgabedatei öffnet. 
Über einen \Macro{eintrag} Befehl legen wir fest, 
dass der Übergabeparameter zusammen mit dem aktuellen Wert des Seitenzählers in diese Datei geschrieben wird.
...
wobei die Ausgabe des \Macro{ausgabe} zugleich für das konkrete Beispiel abgeändert wurde.
...
Im \LaTeX-Dokument muss nun an allen Stellen, 
