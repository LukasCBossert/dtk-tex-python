...
Um für ein gegebenes Stichwort bestimmen zu können, auf welchen Seiten aufgeführt wird, muss diese Information schon auf \LaTeX-Ebene weggeschrieben werden.

Dazu bedienen wir uns des \Command{newwrite} Befehls, der eine neue Ausgabedatei öffnet. Über einen \Command{\eintrag} Befehl legen wir fest, dass der Übergabeparameter zusammen mit dem aktuellen Wert des Seitenzählers in diese Datei geschrieben wird.
